...
基于 Jetpack Compose 开发的校园水控与生活服务 Android 客户端，支持饮水机、吹风机与洗浴等账单查询。
...
-  **现代质感**：基于 Jetpack Compose 与 Material 3 构建，采用亚克力半透明磨砂与微圆角卡片，告别官方 App 的臃肿粗糙；
-  **昼夜双模**：适配 Android 系统深浅色外观切换，宿舍熄灯后打水洗澡柔和不刺眼，日间清新通透；
-  **纯净秒开**：无开屏广告、无推广弹窗与冗余权限，启动即达常用出水与使用码核心操作；
-  **宿舍生活覆盖**：饮水机秒开、后勤洗浴码更换、吹风机消费流水自动召回。
...
从右侧 [Releases](https://github.com/Cainite07/MudLife/releases) 下载最新签名的 `MudLife-v1.3.12.apk`。
...
*特别致敬 [yehu-imei/linyu](https://github.com/yehu-imei/linyu) 项目，感谢其在早期打下的开源基础。*
