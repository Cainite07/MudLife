...
object NetworkModule {
    ...
    private val okHttpClient = OkHttpClient.Builder()
        ...
        .addInterceptor { chain ->
            ...
            if (resp == null) {
                com.hualala.linyu.utils.AppLogger.e("Network", "网络请求彻底失败: ${req.method} ${req.url}", lastException)
            ...
            try {
                ...
                if (isBizFail) {
                    com.hualala.linyu.utils.AppLogger.w("API_FAIL", "[${req.method}] ${req.url.encodedPath} 业务失败: ${body.take(200)}")
                }
            } catch (_: Exception) {}
            resp
        }
